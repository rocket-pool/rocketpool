...
start_ganache() {
  node_modules/.bin/ganache-cli -l 8000000 -e 1000000 -m "jungle neck govern chief unaware rubber frequent tissue service license alcohol velvet" --port "$ganache_port" > /dev/null &
  ganache_pid=$!
}
