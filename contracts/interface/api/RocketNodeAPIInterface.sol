...
contract RocketNodeAPIInterface {
    ...
    function checkDepositReservationIsValid(address _nodeOwner, string memory _durationID, bytes memory _validatorPubkey, uint256 _lastDepositReservedTime) public;
