...
contract BytesListStorageInterface {
    ...
    function setListItem(bytes32 _key, uint _index, bytes _value) external;
    function pushListItem(bytes32 _key, bytes _value) external;
    function insertListItem(bytes32 _key, uint _index, bytes _value) external;
