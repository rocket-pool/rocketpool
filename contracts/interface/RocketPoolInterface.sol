...
contract RocketPoolInterface {
    ...
    function getMiniPoolCanVote(address _minipoolAddress) public returns(bool);
    ...
    function getMiniPoolReadyToLogout(address _minipoolAddress) public returns(bool);
}