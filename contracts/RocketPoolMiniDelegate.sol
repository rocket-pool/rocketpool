...
contract RocketPoolMiniDelegate is Owned {
    ...
    uint256 private stakingBalance;                             // The ether balance sent to the pool after staking was completed in Casper
    uint256 private stakingBalanceReceived;                     // Users in this pool
    ...
    uint8 private version;                                      // Current version of this minipool
