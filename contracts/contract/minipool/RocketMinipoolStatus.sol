...
contract RocketMinipoolStatus is RocketBase {
    ...
    function assignMinipoolDeposit(address _minipool) external payable {}
    ...
    function exitMinipool(address _minipool) external {}

    // Mark a minipool as withdrawable and record its final balance
    // Only accepts calls from trusted (oracle) nodes
    function withdrawMinipool(address _minipool, uint256 _withdrawalBalance) external {
