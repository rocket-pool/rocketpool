...
abstract contract RocketDAONetworkSettings is RocketBase, RocketDAONetworkSettingsInterface {
    ...
    constructor(address _rocketStorageAddress, string memory _settingNameSpace) RocketBase(_rocketStorageAddress) {
        ...
        settingNameSpace = keccak256(abi.encodePacked("dao.network.setting", _settingNameSpace));
    }
    ...
    function setSettingUint(string memory _settingPath, uint256 _value) virtual public override onlyDAONetworkProposal {
        // Update setting now
    ...
    function setSettingBool(string memory _settingPath, bool _value) virtual public override onlyDAONetworkProposal {
        // Update setting now
