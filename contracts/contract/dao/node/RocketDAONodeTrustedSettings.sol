...
contract RocketDAONodeTrustedSettings is RocketBase, RocketDAONodeTrustedSettingsInterface { 
    ...
    constructor(address _rocketStorageAddress) RocketBase(_rocketStorageAddress) public {
        ...
        if(!getBool(keccak256(abi.encodePacked(daoNameSpace, "deployed")))) {
            ...
            setUint(keccak256(abi.encodePacked(daoNameSpace, "proposal.execute.blocks")), 185100);       // How long a proposal be in the queue to be executed. Approx. 4 weeks worth of blocks
    ...
    function setSettingUint(string memory _settingPath, uint256 _value) override external {
        ...
        require(msg.sender == getContractAddress('rocketDAONodeTrusted'), "Only the rocketDAONodeTrusted contract can update a DAO setting");
    ...
    // How long a proposal be in the queue to be executed. Approx. 4 weeks worth of blocks
