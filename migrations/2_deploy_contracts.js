                          ...
                          return deployer.deploy(rocketNode, rocketStorage.address).then(() => {
                            ...
                            return deployer.deploy(rocketPoolMiniDelegate, rocketStorage.address).then(() => {
                              ...
                              return rocketStorage.deployed().then(async rocketStorageInstance => {
                                ...
                                // Rocket Role
                                await rocketStorageInstance.setAddress(
                                  config.web3Utils.soliditySha3('contract.address', rocketRole.address),
                                  rocketRole.address
                                );
                                await rocketStorageInstance.setAddress(
                                  config.web3Utils.soliditySha3('contract.name', 'rocketRole'),
                                  rocketRole.address
                                );
                                // Log it
                                ...
                                // Rocket Upgrade
                                await rocketStorageInstance.setAddress(
                                  config.web3Utils.soliditySha3('contract.address', rocketUpgrade.address),
                                  rocketUpgrade.address
                                );
                                await rocketStorageInstance.setAddress(
                                  config.web3Utils.soliditySha3('contract.name', 'rocketUpgrade'),
                                  rocketUpgrade.address
                                );
                                // Log it
                                ...
                                // Rocket Vault
                                await rocketStorageInstance.setAddress(
                                  config.web3Utils.soliditySha3('contract.address', rocketVault.address),
                                  rocketVault.address
                                );
                                await rocketStorageInstance.setAddress(
                                  config.web3Utils.soliditySha3('contract.name', 'rocketVault'),
                                  rocketVault.address
                                );
                                // Log it
