                      ...
                      return deployer.deploy(rocketFactory, rocketStorage.address).then(() => {
                        ...
                        return deployer.deploy(rocketSettings, rocketStorage.address).then(() => {
                          ...
                          return deployer.deploy(rocketPool, rocketStorage.address).then(() => {
                            ...
                            return deployer.deploy(rocketNodeAdmin, rocketStorage.address).then(() => {
                              // Deploy Rocket Node Status
                              return deployer.deploy(rocketNodeStatus, rocketStorage.address).then(() => {
                                // Deploy Rocket Node Validator
                                return deployer.deploy(rocketNodeValidator, rocketStorage.address).then(() => {
