...
They are the base layer of infrastructure which all other elements of the network are built on, including the JavaScript library, the Smart Node software stack, and all web or application interfaces.
