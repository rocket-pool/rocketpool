...
export const RocketClaimNodeOld = artifacts.require('RocketClaimNodeOld.sol');
...
export const RocketDAOProtocolSettingsNetworkOld = artifacts.require('RocketDAOProtocolSettingsNetworkOld.sol');
