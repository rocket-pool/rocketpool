...
export const RocketTokenDummyGGP = artifacts.require('RocketTokenDummyGGP.sol');
export const GoGoTokenGGPAVAX = artifacts.require('GoGoTokenGGPAVAX.sol');
export const GoGoTokenGGP = artifacts.require('GoGoTokenGGP.sol');
