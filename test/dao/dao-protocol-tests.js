...
export default function() {
    contract('RocketDAONodeTrusted', async (accounts) => {
        ...
        it(printTitle('guardian', 'fails to add more than the 3 min required bootstrap trusted node dao members'), async () => {
            // Add our 3rd member
        ...
        */
        ...
        /*
        it(printTitle('guardian', 'fails to set quorum setting below 51% while bootstrap mode is enabled'), async () => {
            // Update setting
